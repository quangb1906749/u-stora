...
<%-- 	<script src="<c:url value="https://code.jquery.com/jquery.min.js"/>"></script> --%>
	...
	<script
		src="<c:url value="http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"/>"></script>
	...
	<!-- Slider -->
	<script type="text/javascript"
		src="<c:url value="/template/web/js/bxslider.min.js"/>"></script>
	<script type="text/javascript"
		src="<c:url value="/template/web/js/script.slider.js"/>"></script>
